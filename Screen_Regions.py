...
class Screen_Regions:
    def __init__(self, screen, templ):
        ...
        self.reg['fss']       = {'rect': [0.5085, 0.7324, 0.5398, 0.76], 'width': 1, 'height': 1, 'filterCB': self.equalize, 'filter': None}
        self.reg['fss_full']       = {'rect': [0.5085, 0.7324, 0.5398, 0.76], 'width': 1, 'height': 1, 'filterCB': self.equalize, 'filter': None}
    ...
    def capture_region_save(self, region_name, filename):
        return self.screen.get_screen_region_save(self.reg[region_name]['rect'], filename)  
